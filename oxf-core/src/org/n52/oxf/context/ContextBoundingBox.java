...
public class ContextBoundingBox implements IEventEmitter, IContextSerializableXML {
    ...
    /**
     * Angefragter Ausschnitt wird an die kleinere Ausdehung angepasst; das führt insbesondere beim initialen
    ...
    private Rectangle2D.Double buildRectangle(Point2D lowerLeft, Point2D upperRight) {
        ...
        double y = lowerLeft.getY(); // TODO: muss das hier nicht upperRight.getY() heißen??
