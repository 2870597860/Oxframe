 ...
 * 
 */
public class GetFOI_Configurator extends JDialog {
    ...
    protected GetFOI_ConfiguratorController controller;
    private TimePeriodPanel timePP;

    /**
     * This is the default constructor
     */
    public GetFOI_Configurator(JDialog owner, URL serviceURL, SOSAdapter adapter) {
        super(owner, "获取要素的地理位置");

        initialize(owner);
        controller = new GetFOI_ConfiguratorController(this, serviceURL, adapter);
    }
