 ...
 * 
 */
public class GetFOI_ConfiguratorController{
    ...
    private GetFOI_Configurator view;
     ...
     * 
     */
    public GetFOI_ConfiguratorController(GetFOI_Configurator view, URL serviceURL, SOSAdapter adapter) {
        this.view = view;
    ...
    public void init() {
        ...
        Parameter versionParameter = serviceDesc.getOperationsMetadata().getOperationByName(SOSAdapter.GET_OBSERVATION_BY_ID).getParameter(ISOSRequestBuilder.DESCRIBE_SENSOR_VERSION_PARAMETER);
        ...
        Parameter serviceParameter = serviceDesc.getOperationsMetadata().getOperationByName(SOSAdapter.GET_OBSERVATION_BY_ID).getParameter(ISOSRequestBuilder.DESCRIBE_SENSOR_SERVICE_PARAMETER);
        ...
        //Parameter sensorIdParameter = serviceDesc.getOperationsMetadata().getOperationByName(SOSAdapter.GET_FEATURE_OF_INTEREST).getParameter(ISOSRequestBuilder.GET_OBSERVATION_FEATURE_OF_INTEREST_PARAMETER);
    ...
    public void actionPerformed_okButton() {
        try {
            ...
            String postRequest = adapter.getRequestBuilder().buildGetFeatureOfInterestRequest(paramCon);
            ...
            if (returnVal == ApprovalDialog.APPROVE_OPTION) {
                ...
                new ShowXMLDocDialog(view.getLocation(), "元素的位置是", describeSensorDoc).setVisible(true);
            }
        }
        catch (OXFException e) {
            if (e.getCause() instanceof ConnectException) {
