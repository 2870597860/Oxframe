...
public class ConnectSOSDialog extends JDialog {
    ...
    protected JButton getFeatureOfInterestButton=null;  //添加的
    protected JButton registerSensorCButton=null;  //添加的
    protected JButton InsertObservationButton=null; //添加的
    ...
    private JButton showSensorPositionsButton;
    ...
    protected JPanel getMainPanel() {
        if (mainPanel == null) {
            ...
            mainPanel.add(getIsMobileChB(), gbcIsMobileChB);
        }
        return mainPanel;
    }
    ...
    protected JPanel getJContentPane() {
        if (jContentPane == null) {
            ...
            gridBagConstraints.weightx = 100.0D;  //指定如何分布额外的水平空间。
            gridBagConstraints.weighty = 100.0D;  //指定如何分布额外的水平空间。
            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
            gridBagConstraints.gridheight = 3;  //指定在组件显示区域的一列中的单元格数。
    ...
    protected JPanel getButtonPanel() {
        if (buttonPanel == null) {
            ...
            buttonPanel.add(getFOIButton(), gridBagConstraints7);
            buttonPanel.add(getRegisterSensorButton(),gridBagConstraints8);
            buttonPanel.add(getInsertObservationButton(),gridBagConstraints9);
    ...
    /**
     * @param boolean true if buttons are to be added, false if removed
     */
    protected void mobileButtonsToPanel(boolean addOrRemove) {

        GridBagConstraints gridBagConstraints7 = new GridBagConstraints();
        gridBagConstraints7.insets = new java.awt.Insets(10, 5, 0, 0);
        gridBagConstraints7.gridy = 2;
        gridBagConstraints7.weightx = 0.0D;
        gridBagConstraints7.weighty = 0.0D;
        gridBagConstraints7.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        if (addOrRemove) {
            buttonPanel.add(getShowSensorPositionsFeatureButton(), gridBagConstraints7);
        }
        else {
            buttonPanel.remove(getShowSensorPositionsFeatureButton());
        }
    }
   ...
   protected JButton getFOIButton(){
	   
		   getFeatureOfInterestButton = new JButton();
		   getFeatureOfInterestButton.setText("获取元素的地理位置");
		   getFeatureOfInterestButton.setPreferredSize(new java.awt.Dimension(320,
                                                                        PREFERRED_GET_BUTTON_HEIGHT));
		   getFeatureOfInterestButton.addActionListener(new java.awt.event.ActionListener() {
               public void actionPerformed(java.awt.event.ActionEvent e) {
                   controller.actionPerformed_getFOIButton(e);
               }
           });
      
       return getFeatureOfInterestButton;  
   }
   protected JButton getRegisterSensorButton() {
       if (registerSensorCButton == null) {
    	   registerSensorCButton = new JButton();
    	   registerSensorCButton.setText("注册传感器");
    	   registerSensorCButton.setPreferredSize(new java.awt.Dimension(PREFERRED_GET_BUTTON_WIDTH,
                                                                        PREFERRED_GET_BUTTON_HEIGHT));
    	   registerSensorCButton.addActionListener(new java.awt.event.ActionListener() {
               public void actionPerformed(java.awt.event.ActionEvent e) {
                   controller.actionPerformed_RegisterSensorButton(e);
               }
           });
       }
       return registerSensorCButton;  
   }
   
   protected JButton getInsertObservationButton() {   
       if (InsertObservationButton == null) {
    	   InsertObservationButton = new JButton();
    	   InsertObservationButton.setText("插入观测数据");
    	   InsertObservationButton.setPreferredSize(new java.awt.Dimension(PREFERRED_GET_BUTTON_WIDTH,
                                                                        PREFERRED_GET_BUTTON_HEIGHT));
    	   InsertObservationButton.addActionListener(new java.awt.event.ActionListener() {
               public void actionPerformed(java.awt.event.ActionEvent e) {
                   controller.actionPerformed_InsertObservationButton(e);
               }
           });             
       }
       return InsertObservationButton;            //插入观测按钮
   }
    /**
    ...
    /**
     * This method initializes isMobile Checkbox
     * 
     * @return javax.swing.JCheckBox
     */
    public JCheckBox getIsMobileChB() {
        if (isMobileChB == null) {
            isMobileChB = new JCheckBox();
            isMobileChB.setMnemonic(KeyEvent.VK_M);
            this.isMobileChB.addItemListener(new ItemListener() {
                @Override
                public void itemStateChanged(ItemEvent e) {

                    mobileButtonsToPanel(isMobileChB.isSelected());
    ...
    /**
     * This method initializes getSamplingFeatureButton
     * 
     * @return javax.swing.JButton
     */
    protected JButton getShowSensorPositionsFeatureButton() {
        if (showSensorPositionsButton == null) {
            showSensorPositionsButton = new JButton();
            showSensorPositionsButton.setText("Add Sensor Position to Map");
            showSensorPositionsButton.setPreferredSize(new java.awt.Dimension(PREFERRED_GET_BUTTON_WIDTH,
                                                                              PREFERRED_GET_BUTTON_HEIGHT));
            showSensorPositionsButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    controller.actionPerformed_showSensorPositionsButton(e);
                }
            });
        }
        return showSensorPositionsButton;
    }
