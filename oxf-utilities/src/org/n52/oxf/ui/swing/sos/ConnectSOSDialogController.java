...
public class ConnectSOSDialogController {
    ...
    //下面为添加的内容
    public void actionPerformed_getFOIButton(ActionEvent event) {
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("获取要素的地理位置 action");
        }
        ...
        try {
            ...
            new GetFOI_Configurator(view, url, adapter).setVisible(true);
        }
        catch (MalformedURLException e) {
            e.printStackTrace();
        }
  ...
  //下面为添加的内容
    public void actionPerformed_RegisterSensorButton(ActionEvent event) {
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("注册传感器 action");
        }
        ...
        try {
            ...
            new RegisterSensor_Configurator(view, url, adapter).setVisible(true);
        }
        catch (MalformedURLException e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed_InsertObservationButton(ActionEvent event) {
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("插入观测 action");
        }
        ...
        try {
            ...
            new InsertObservation_Configurator(view, url, adapter).setVisible(true);
        }
        catch (MalformedURLException e) {
            e.printStackTrace();
        }
