...
public class ProjectMenu extends Menu {
    ...
    public ProjectMenu(JFrame owner, MapCanvas map, ContentTree tree) {
        super(owner, map, tree, "项目");

        saveProjectMI = new JMenuItem("保存项目");
        openProjectMI = new JMenuItem("打开项目");
        saveContextMI = new JMenuItem("保存文本");//Save Context
        openContextMI = new JMenuItem("打开文本");//Open Context
