...
import org.n52.oxf.ui.swing.sas.ConnectSASDialog;
...
public class ConnectServiceMenu extends Menu {
    ...
    public ConnectServiceMenu(JFrame owner, MapCanvas map, ContentTree tree) {
        super(owner, map, tree, "访问服务");
        
        connectCSWMenuItem = new JMenuItem("CSW服务");
        connectSOSMenuItem = new JMenuItem("SOS服务");
        connectSASMenuItem = new JMenuItem("SAS服务");
        connectWMSMenuItem = new JMenuItem("WMS服务");
        connectWCSMenuItem = new JMenuItem("WCS服务");
        connectSPSMenuItem = new JMenuItem("SPS服务");
        connectSESMenuItem = new JMenuItem("SES服务");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        else if (e.getSource().equals(connectSASMenuItem)) {
            new ConnectSASDialog(owner).setVisible(true);
        }
