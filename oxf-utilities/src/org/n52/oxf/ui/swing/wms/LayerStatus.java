...
public class LayerStatus {
	...
	public static String STATUS_REQUEST_INITIATED = "已初始化请求";
	public static String STATUS_NEW_LAYER_ADDED = "Adding layer initiated - 查询服务";
	public static String STATUS_OPERATION_RESULT_RECEIVED = "接收到服务响应 - 显示初始化";
	public static String STATUS_LAYER_VISUALIZATION_READY = "准备可视化...";
	public static String STATUS_READY_TO_OVERLAY ="完成"; //STATUS_READY_TO_OVERLAY ="Done";
