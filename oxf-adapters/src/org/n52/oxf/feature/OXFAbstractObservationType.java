...
public class OXFAbstractObservationType extends OXFAbstractFeatureType {
    ...
    public void initializeFeature(OXFFeature feature,
                                  net.opengis.om.x00.AbstractObservationType xb_abstractObservation) throws OXFException {
        super.initializeFeature(feature, xb_abstractObservation);

        
        // create the PROCEDURE-attribute:
        ProcedurePropertyType xb_procedureProperty = xb_abstractObservation.getProcedure();
        ...
        PhenomenonPropertyType xb_observedProperty = xb_abstractObservation.getObservedProperty();
