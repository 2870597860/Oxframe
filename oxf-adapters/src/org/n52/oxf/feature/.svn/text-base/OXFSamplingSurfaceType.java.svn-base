...
public class OXFSamplingSurfaceType extends OXFAbstractFeatureType {
    ...
    public void initializeFeature(OXFFeature feature,
        ...
        if (xb_saSurface.getShape() != null
        		&& xb_saSurface.getShape().getSurface() != null
                && ((PolygonType)xb_saSurface.getShape().getSurface()).getExterior() != null
                && ((PolygonType)xb_saSurface.getShape().getSurface()).getExterior().getRing() != null) {

            PolygonType xb_polygon = (PolygonType)xb_saSurface.getShape().getSurface();
