...
public class OXFMeasurementType extends OXFAbstractObservationType {
     ...
     * supports O&M 0.0:
     */
    public void initializeFeature(OXFFeature feature, net.opengis.om.x00.MeasurementType xb_measurement) throws OXFException {
        super.initializeFeature(feature, xb_measurement);

        // create the RESULT-attribute:

        OXFMeasureType measureResult = new OXFMeasureType(xb_measurement.getResult().getUom(),
                                                          xb_measurement.getResult().getDoubleValue());
