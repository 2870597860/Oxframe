...
public class SESAdapter implements IServiceAdapter {
    ...
    public ServiceDescriptor initService(String serviceURL) throws ExceptionReport, OXFException {
        ...
        parameters.addParameterShell(ISESRequestBuilder.GET_CAPABILITIES_SES_URL, serviceURL);  //增加参数
    ...
    //下面是添加的
    public ISESRequestBuilder getRequestBuilder() {
        return SESRequestBuilderFactory.generateRequestBuilder(serviceVersion);
    }
    //上面是添加的
