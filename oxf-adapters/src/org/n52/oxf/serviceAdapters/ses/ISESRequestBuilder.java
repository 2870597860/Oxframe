...
public interface ISESRequestBuilder {
    ...
    public static final String SUBSCRIBE_FILTER_MESSAGE_CONTENT = "subscribeFilterFirstProperty"; 
    public static final String SUBSCRIBE_FILTER_MESSAGE_SECOND_CONTENT = "subscribeFilterSecondProperty";  //第二个属性
    public static final String SUBSCRIBE_INITIAL_TERMINATION_TIME = "subscribeInitialTerminationTime";
    public static final String SUBSCRIBE_FILTER_MESSAGE_CONTENT_OBSERVEDPROPERTY = "subscribeObservedProperty";//添加的
    public static final String SUBSCRIBE_FILTER_MESSAGE_CONTENT_THRESHOLD = "subscribeObservedPropertyThreshold";//添加的门限  
    public static final String SUBSCRIBE_FILTER_MESSAGE_CONTENT_SECOND_THRESHOLD = "subscribeObservedPropertySecondThreshold";//添加的第二个门限
    public static final String SUBSCRIBE_FILTER_MESSAGE_CONTENT_THRESHOLD_VALUE = "subscribeObservedPropertyThresholdValue";//添加的门限值   
    public static final String SUBSCRIBE_FILTER_MESSAGE_CONTENT_SECOND_THRESHOLD_VALUE = "subscribeObservedPropertySecondThresholdValue";//添加的第二个门限值
    ...
    public static final String NOTIFY_SES_URL = "notifySesUrl"; //已添加
    public static final String NOTIFY_TOPIC_DIALECT = "notifyTopicDialect"; //已添加
    public static final String NOTIFY_TOPIC = "notifyTopic";  //已添加
    public static final String NOTIFY_XML_MESSAGE = "notifyXmlMessage";  //已添加
