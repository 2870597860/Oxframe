...
import net.opengis.ogc.FilterCapabilitiesDocument.FilterCapabilities;
import net.opengis.sos.x00.CapabilitiesDocument;
import net.opengis.sos.x00.ContentsDocument;
import net.opengis.sos.x00.ObservationOfferingType;
import net.opengis.sos.x00.ResponseModeType;
import net.opengis.swe.x00.CompositePhenomenonType;
 ...
 * 
 */
public class SOSCapabilitiesMapper_000 {
     ...
     * @param contents
     */
    private void addDatasetParameterFromContentsSection(OperationsMetadata operationsMetadata,
                                                        SOSContents contents) {
     ...
     * @return
     */
    private OperationsMetadata mapOperationsMetadata(OperationsMetadataDocument.OperationsMetadata xb_opMetadata) {
        ...
        for (int i = 0; i < xb_operations.length; i++) {
            ...
            for (int j = 0; j < xb_parameters.length; j++) {
                ...
                if (parameterName.equalsIgnoreCase("eventTime")) {
                    ...
                    Parameter oc_parameter = new Parameter(parameterName,
                                                           oc_required,
                                                           oc_values,
                                                           null);
    ...
    private SOSContents mapContents(CapabilitiesDocument capabilitiesDoc) throws OXFException {
        ...
        for (int i = 0; i < xb_obsOfferings.length; i++) {
            ...
            if (xb_obsOffering.getTime() != null
                    && xb_obsOffering.getTime().getTimeGeometricPrimitive() != null) {
     ...
     * @return
     */
    private ServiceIdentification mapServiceIdentification(net.opengeospatial.ows.ServiceIdentificationDocument.ServiceIdentification xb_serviceId) {
