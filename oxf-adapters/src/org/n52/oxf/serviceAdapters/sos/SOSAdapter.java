...
public class SOSAdapter implements IServiceAdapter {
    ...
    public ServiceDescriptor initService(OperationResult getCapabilitiesResult) throws ExceptionReport, OXFException {
        ...
        try {
            if (serviceVersion.equals(SOSAdapter.SUPPORTED_VERSIONS[0])) {
                net.opengis.sos.x00.CapabilitiesDocument capsDoc = net.opengis.sos.x00.CapabilitiesDocument.Factory.parse(getCapabilitiesResult.getIncomingResultAsStream());
     ...
     * @throws OXFException
     */
    public ServiceDescriptor initService(net.opengis.sos.x00.CapabilitiesDocument capsDoc) throws OXFException {
        SOSCapabilitiesMapper_000 capsMapper = new SOSCapabilitiesMapper_000();
    ...
    public OperationResult doOperation(Operation operation, ParameterContainer parameters) throws ExceptionReport,
        ...
        try {
            ...
            if (operation.getName().equals(GET_CAPABILITIES)) {
            	...
            	//operation.getDcps()[0].getHTTPPostRequestMethods().get(0).getOnlineResource().getHref())ÊÇ×Ö·û´®£º
