...
public class CoverageProcessor {
    ...
    public IntCoverage classifyCoverage(DoubleCoverage doubleCoverage,
        ...
        int grade = 1; // Hilfsvariable für die Klassifizierung
    ...
    public Image createImage(IntCoverage intCoverage, int numberOfClasses, String colorPalette) {
        ...
        // Bildgröße gemäß der Rastergröße festlegen
        ...
        // Es ist wichtig, dass zuerst height und dann width durchgezählt wird.
    ...
    public int computeCellColor(int cellValue, int numberOfClasses, String colorPalette) {
        // Variablen für die Formel zum Erstellen einer ColorRamp.
        // Für jedes Band(Rot, Grün, Blau)gibt es einen Start- und Endwert.
        int startR;
        int endR;
        int startG;
        int endG;
