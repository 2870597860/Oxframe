...
import com.google.earth.kml.x21.BalloonStyleType;
...
public class SimpleOM2KMLRenderer implements IFeatureDataRenderer {
    ...
    public IVisualization renderLayer(OXFFeatureCollection observationCollection,
        ...
        for (OXFFeature feature : selectedFoiSet) {
            ...
            xb_placemark.setGeometry(xb_Point);
        ...
        xb_document.setFeatureArray(placemarks);
        xb_document.setStyleSelectorArray(styles);
        xb_kml.setFeature(xb_document);
